  ...
  return (
    <div className="md:px-20 px-8 md:py-14 py-8">
      <div className="max-w-7xl mx-auto">
        <div className=" text-sm text-gray-900 mb-5 flex items-center flex-wrap gap-1">
        ...
        <h1 className="md:text-3xl text-2xl font-bold mb-5 md:mt-10 mt-">
          {title}
        </h1>
        ...
        {toppers.length > 0 ? (
          <div
            ref={gridRef}
            className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 sm:gap-x-6 gap-x-3 md:gap-y-12 gap-y-3 pb-12" // increased gap-y + padding bottom
          >
            {toppers.map((holder) => (
              <div
      ...
      "
              ...
              >
                ...
                <img
                  src={server_url + holder.topper_image || "/placeholder.svg"}
