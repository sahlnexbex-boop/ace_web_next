...
export default function PublicationDetails() {
  ...
  const books = [
    ...
    { id: 4, title: "Malayalam Grammar File", category: "HSA Malayalam", price: 160, author: "ACE Publication", language: "MALAYALAM", image: "/book_04.png" },
    { id: 11, title: "English Grammar Guide", category: "HSA English", price: 160, author: "ACE Publication", language: "ENGLISH", image: "/book_11.png" },
    { id: 12, title: "Current Affairs Book", category: "ACE PUBLICATIONS", price: 580, author: "ACE Publication", language: "ENGLISH", image: "/book_12.png" },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 md:py-16 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-10 mb-12">
        <img src={book.image} alt={book.title} className="w-full md:w-1/3 object-contain rounded-lg" />
        <div className="flex-1 flex flex-col justify-center items-start">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">{book.title}</h1>
          <p className="text-xl font-bold text-gray-800 mb-5">₹{book.price}</p>
          <p className="text-xl font-bold text-gray-500 mb-10">Author: ook.author}</p>
          ...
          <button className="border rounded-lg px-5 py-2 flex items-center gap-2 hover:bg-gray-100 transition">
            🤍 Add To Wishlist
          </button>
        </div>
      </div>
      ...
      {related.length > 0 && (
        <>
          <h2 className="text-xl md:text-2xl font-bold text-center text-gray-900 mb-8">Other Books</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 overflow-x-auto snap-x md:overflow-visible">
            {related.map((r) => (
              ...
              >
                <img src={r.image} alt={r.title} className="w-full h-60 object-contain mb-2" />
